...
public class ProductHistoryController extends HttpServlet {
    ...
    private static final String HISTORY="product_history.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductHistoryDTO> list=dao.listProductHistory();
            ...
            log("ERROR At ProductHistoryController: " + e.getMessage());
        }finally{
